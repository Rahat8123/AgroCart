...
class TTextTheme {
  ...
  // Define opacity variable for reuse
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    bodySmall: TextStyle(fontSize: 14.0, fontWeight: FontWeight.w500, color: Colors.black.withOpacity(textOpacity)),

    labelLarge: TextStyle(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.black),
    labelMedium: TextStyle(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.black.withOpacity(textOpacity)),
  );
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    bodySmall: TextStyle(fontSize: 14.0, fontWeight: FontWeight.w500, color: Colors.white.withOpacity(textOpacity)),

    labelLarge: TextStyle(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.white),
    labelMedium: TextStyle(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.white.withOpacity(textOpacity)),
  );
}
